...
import AddOrEditPlayers from "./Components/Admin/Players/AddOrEditPlayers";
    ...
    return (
        <Layout>
            <Switch>
                ...
                <PrivateRoute
                    {...props}
                    path="/admin_jogadores/adicionar"
                    exact
                    component={AddOrEditPlayers}
                />
                <PrivateRoute
                    {...props}
                    path="/admin_jogadores/editar/:id"
                    exact
                    component={AddOrEditPlayers}
                />
                <PrivateRoute
